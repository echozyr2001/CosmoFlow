...
//!
//! impl cosmoflow::storage::backends::StorageBackend for MockStorage {
...
///
/// **DEPRECATED**: Use the unified `SharedStore` trait instead.
#[deprecated(since = "0.2.0", note = "Use the unified `SharedStore` trait instead")]
#[allow(deprecated)]
#[derive(Debug)]
