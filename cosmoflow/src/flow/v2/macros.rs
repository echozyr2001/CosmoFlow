...
///
/// ```rust,ignore
/// let flow = cosmoflow::flow::v2::flow! {
///     nodes {
///         load = LoadUser;
///         score = ScoreUser;
///         done = Done;
...
#[doc(hidden)]
#[macro_export]
macro_rules! __cosmoflow_v2_flow {
    (
        start = $start:ident;
...
pub use crate::__cosmoflow_v2_flow as flow;

#[cfg(all(test, feature = "storage-memory"))]
mod tests {
    use crate::action::v2::Action;
    #[cfg(not(feature = "async"))]
    use crate::flow::v2::FlowBuilder;
    use crate::flow::v2::FlowError;
    use crate::node::v2::{Node, NodeContext, NodeId};
    ...
    fn macro_matches_manual_builder() {
        let mut macro_flow = crate::flow::v2::flow! {
            nodes {
    ...
    fn explicit_start_overrides_default_start() {
        let mut flow = crate::flow::v2::flow! {
            start = score;
    ...
    fn nested_flow_nodes_are_accepted() {
        ...
        let mut outer = crate::flow::v2::flow! {
            nodes {
                nested = inner;
            }
